...
| **UI Вёрстка** | 🔄 **В процессе** (Фаза 1.4-A завершена) |
...
### Фаза 1.4-A: Навигация и Профиль ✅
- [x] MainShell (Bottom Navigation: Search, Trips, Chats, Profile)
- [x] ProfileScreen (просмотр профиля)
- [x] EditProfileScreen (редактирование имени, email, аватара)
- [x] SettingsScreen (настройки, logout, logout-all)
- [x] Placeholder screens для Search, Trips, Chats

### Фаза 1.4-B: Главная и Поиск
- [ ] HomeScreen/SearchScreen (поиск поездок)
- [ ] SearchResultsScreen
- [ ] FiltersScreen
...
### Фаза 1.8: Профиль (частично в 1.4-A)
- [x] ProfileScreen (перенесено в 1.4-A)
- [x] EditProfileScreen (перенесено в 1.4-A)
- [x] SettingsScreen (перенесено в 1.4-A)
